      ...
      <div className="min-h-screen bg-white w-full overflow-x-hidden">
        ...
        <header className="fixed top-0 left-0 right-0 h-14 sm:h-16 lg:h-20 z-50 bg-white border-b border-[#E2E2E2]">
          <div className="max-w-7xl mx-auto px-2 sm:px-4 h-full">
            {/* Mobile/Tablet: A B C D layout with equal spacing */}
            <div className="flex lg:hidden items-center justify-between gap-1.5 sm:gap-2 h-full">
              ...
              <Link to="/dashboard/links" className="flex items-center gap-1 px-1.5 sm:px-2 py-1.5 sm:py-2 rounded-md bg-[#EFEBFF] text-[#633CFF] flex-shrink-0">
                <img src="/assets/images/icon-link.svg" alt="Links" className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" style={{ filter: 'invert(32%) sepia(97%) saturate(7492%) hue-rotate(251deg) brightness(91%) contrast(101%)' }} />
              </Link>

              <Link to="/dashboard/profile" className="group flex items-center gap-1 px-1.5 sm:px-2 py-1.5 sm:py-2 rounded-md text-[#737373] hover:bg-gray-100 flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 20" className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0 fill-[#737373] group-hover:fill-[#633CFF] transition-colors">
              ...
              <button onClick={() => user?.id && window.open(`/preview/${user.id}`, "_blank")} className="flex items-center gap-1 bg-white border border-[#633CFF] text-[#633CFF] px-1.5 sm:px-2 py-1.5 sm:py-2 rounded-md hover:bg-[#EFEBFF] active:bg-[#EFEBFF] disabled:border-[#D9D9D9] disabled:text-[#737373] disabled:cursor-not-allowed flex-shrink-0 transition">
            ...
            {/* Desktop: A BC D layout with justify-between */}
            <div className="hidden lg:flex items-center justify-between h-full">
              ...
              <nav className="flex gap-2">
                <Link to="/dashboard/links" className="flex items-center gap-1 px-4 py-2 rounded-lg bg-[#EFEBFF] text-[#633CFF]">
                  <img src="/assets/images/icon-link.svg" alt="Links" className="w-5 h-5 flex-shrink-0" style={{ filter: 'invert(32%) sepia(97%) saturate(7492%) hue-rotate(251deg) brightness(91%) contrast(101%)' }} />
                  <span className="text-sm font-semibold">Links</span>
                </Link>

                <Link to="/dashboard/profile" className="group flex items-center gap-1 px-4 py-2 rounded-lg text-[#737373] hover:bg-gray-100">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 21 20" className="w-5 h-5 flex-shrink-0 fill-[#737373] group-hover:fill-[#633CFF] transition-colors">
                    <path d="M10.5 1.563A8.437 8.437 0 1 0 18.938 10 8.447 8.447 0 0 0 10.5 1.562ZM6.716 15.357a4.688 4.688 0 0 1 7.568 0 6.54 6.54 0 0 1-7.568 0Zm1.596-5.982a2.188 2.188 0 1 1 4.376 0 2.188 2.188 0 0 1-4.376 0Zm7.344 4.683a6.523 6.523 0 0 0-2.265-1.83 4.062 4.062 0 1 0-5.782 0 6.522 6.522 0 0 0-2.265 1.83 6.562 6.562 0 1 1 10.304 0h.008Z" />
                  </svg>
                  <span className="text-sm text-[#737373] group-hover:text-[#633CFF] transition-colors">Profile Details</span>
                </Link>
              </nav>

              <button onClick={() => user?.id && window.open(`/preview/${user.id}`, "_blank")} className="flex items-center gap-1 bg-white border border-[#633CFF] text-[#633CFF] px-4 py-2 rounded-lg hover:bg-[#EFEBFF] active:bg-[#EFEBFF] disabled:border-[#D9D9D9] disabled:text-[#737373] disabled:cursor-not-allowed flex-shrink-0 transition">
