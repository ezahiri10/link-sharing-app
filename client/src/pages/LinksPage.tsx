  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#FAFAFA]">
        {/* HEADER - Fixed at top, height 80px (h-20) */}
        ...
        {/* MAIN - Guaranteed 112px offset (80px header + 32px gap) */}
        <main 
          id="links-page-main"
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            {/* PHONE PREVIEW - Guaranteed sticky at 112px */}
            <div
            ...
            {/* EDITOR - Fixed header, scrollable content */}
            <div className="lg:col-span-3 bg-white rounded-xl w-full flex flex-col">
              
              {/* FIXED HEADER - Title and Add Button */}
              ...
              {/* SCROLLABLE CONTENT - Forms and Links */}
              <div id="links-editor-content" className="p-6 space-y-6 flex-1">
